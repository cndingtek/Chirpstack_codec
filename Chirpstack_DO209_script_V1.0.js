/***********************************************************************************************************
 * Radar+Magnet Parking Lots Detector DO209 Codec for Chirpstack/TTN(The Things Network).
 * Version 1.0  Date 2026-4-2
 * 
...
switch (test_mode) {
    case 1:
        Input = {
            fPort: 3,
            //bytes: [0x80, 0x00, 0x32, 0x02, 0x17, 0x00, 0x00, 0x11, 0x10, 0x01, 0x62, 0x01, 0x9F, 0xFC, 0x7E, 0xF9, 0x6F, 0x1A, 0x11, 0x00, 0x02, 0x00, 0x81],
            //bytes: [0x80, 0x00, 0x01, 0x02, 0x0D, 0x01, 0x02, 0x18, 0x0A, 0x14, 0x19, 0x00, 0x81],
            bytes: [0x80, 0x00, 0x32, 0x03, 0x10, 0x01, 0x02, 0x18, 0x1E, 0x3C, 0x00, 0x28, 0x14, 0x00, 0x00, 0x81],
            variables: {}
        };
