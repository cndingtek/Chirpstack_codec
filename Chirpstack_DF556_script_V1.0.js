/***********************************************************************************************************
 * CNDINGTEK pressure Level sensor DF556 Codec for Chirpstack/TTN(The Things Network).
 * Version 1.3  Date 2023-6-17
 * 
...
switch (test_mode) {
    case 1:
        Input = {
            fPort: 3,
            bytes: [0x80, 0x00, 0x16, 0x03, 0x10, 0x05, 0x01, 0x00, 0x1E, 0x0A, 0x1E, 0x00, 0x00, 0x14, 0x00, 0x81],
    ...
    case 2:
        Input = {
            fPort: 3,
            bytes: [0x38, 0x30, 0x30, 0x32, 0x39, 0x39, 0x39, 0x39, 0x30, 0x41, 0x30, 0x32, 0x31, 0x45, 0x38, 0x31],
            variables: {}
        };
...
function decodeDownlink(input) {
    ...
    switch (option) {
        ...
        case 10:
            return {
                data: {
                    batteryThreshold: parseInt(String.fromCharCode(input.bytes[10]) + String.fromCharCode(input.bytes[11]) + String.fromCharCode(input.bytes[12]) + String.fromCharCode(input.bytes[13]), 16),
                },
            };
        case 9:
            switch (value) {
